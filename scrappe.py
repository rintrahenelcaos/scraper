...
def conection_sql():
    ...
    #conector = sqlite3.connect(file_path, check_same_thread=False)
    return conector
...
class Updater2(QObject):
    
    finished = pyqtSignal()
    progress = pyqtSignal(int)
    #conector_th = sqlite3.connect("cedearsdb.db")
    ...
    def update(self):
        ...
        self.actualize_scrapper(code_list, float(self.dollar))
        
        #self.updated.emit()
        return self.dollar
    
    def actualize_scrapper(self,code_list, dollar):
        """Connects scrapper to sqlite db prior to cleaning data
...
class Main_window(QMainWindow):
    ...
    def __init__(self):
        ...
        #self.timed_update.finished.connect(self.timed_update.deleteLater)
    ...
    def starter(self):
        ...
        self.thread.start()
        self.thread.finished.connect(lambda: self.infolabel.setText("table updated"))
